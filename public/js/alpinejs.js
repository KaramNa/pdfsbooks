(() => { var Ke = !1,
        ...
        function Vr(e) { X.includes(e) || X.push(e), Br() }

        function Br() {!ze && !Ke && (Ke = !0, queueMicrotask(Hr)) }

        function Hr() { Ke = !1, ze = !0; for (let e = 0; e < X.length; e++) X[e]();
            X.length = 0, ze = !1 } var w, M, U, Ve, Be = !0;

        function At(e) { Be = !1, e(), Be = !0 }

        function Ot(e) { w = e.reactive, U = e.release, M = t => e.effect(t, { scheduler: r => { Be ? St(r) : r() } }), Ve = e.raw }

        function He(e) { M = e }

        function Tt(e) { let t = () => {}; return [n => { let i = M(n);
                e._x_effects || (e._x_effects = new Set, e._x_runEffects = () => { e._x_effects.forEach(o => o()) }), e._x_effects.add(i), t = () => { i !== void 0 && (e._x_effects.delete(i), U(i)) } }, () => { t() }] } var Ct = [],
            Rt = [],
            Mt = [];

        function Nt(e) { Mt.push(e) }

        function kt(e) { Rt.push(e) }

        function Dt(e) { Ct.push(e) }

        function Pt(e, t, r) { e._x_attributeCleanups || (e._x_attributeCleanups = {}), e._x_attributeCleanups[t] || (e._x_attributeCleanups[t] = []), e._x_attributeCleanups[t].push(r) }

        function qe(e, t) {!e._x_attributeCleanups || Object.entries(e._x_attributeCleanups).forEach(([r, n]) => {
                (t === void 0 || t.includes(r)) && (n.forEach(i => i()), delete e._x_attributeCleanups[r]) }) } var We = new MutationObserver(Ue),
            Ge = !1;

        function Ye() { We.observe(document, { subtree: !0, childList: !0, attributes: !0, attributeOldValue: !0 }), Ge = !0 }

        function Ur() { qr(), We.disconnect(), Ge = !1 } var ee = [],
            Je = !1;

        function qr() { ee = ee.concat(We.takeRecords()), ee.length && !Je && (Je = !0, queueMicrotask(() => { Wr(), Je = !1 })) }

        function Wr() { Ue(ee), ee.length = 0 }

        function h(e) { if (!Ge) return e();
            Ur(); let t = e(); return Ye(), t } var Ze = !1,
            me = [];

        function It() { Ze = !0 }

        function Lt() { Ze = !1, Ue(me), me = [] }

        function Ue(e) { if (Ze) { me = me.concat(e); return } let t = [],
                r = [],
                n = new Map,
            ...
            i.forEach((o, s) => { qe(s, o) }), n.forEach((o, s) => { Ct.forEach(a => a(s, o)) }); for (let o of t) r.includes(o) || Mt.forEach(s => s(o)); for (let o of r) t.includes(o) || Rt.forEach(s => s(o));
            t = null, r = null, n = null, i = null }

        function W(e, t, r) { return e._x_dataStack = [t, ...F(r || e)], () => { e._x_dataStack = e._x_dataStack.filter(n => n !== t) } }
        ...
        function N(e) { let t = new Proxy({}, { ownKeys: () => Array.from(new Set(e.flatMap(r => Object.keys(r)))), has: (r, n) => e.some(i => i.hasOwnProperty(n)), get: (r, n) => (e.find(i => { if (i.hasOwnProperty(n)) { let o = Object.getOwnPropertyDescriptor(i, n); if (o.get && o.get._x_alreadyBound || o.set && o.set._x_alreadyBound) return !0; if ((o.get || o.set) && o.enumerable) { let s = o.get,
                                a = o.set,
                                c = o;
        ...
        function he(e) { let t = n => typeof n == "object" && !Array.isArray(n) && n !== null,
