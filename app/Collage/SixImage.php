...
class SixImage extends CollageGenerator
{
    /**
     * @var Image
     */
    ...
    public function grid()
    {
        ...
        $this->canvas->insert($four->fit($width, $height), 'bottom-left');

        $five = $this->images->get(4);
        $this->canvas->insert($five->fit($width, $height), 'bottom-center');

        $six = $this->images->get(5);
        $this->canvas->insert($six->fit($width, $height), 'bottom-right');
    }
