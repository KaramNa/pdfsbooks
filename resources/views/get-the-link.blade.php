            ...
            <div class="col-12 text-center">
                ...
                <div id="link" class="d-none">
                    <div class="d-flex justify-content-around align-items-center">
                        <span class="blink h1 wine-color"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="100" height="100">
                                <g fill='#800000'>
                                    <path
                        ...
                        <a href="<?php echo $d_link; ?>" target="_blank" class="h2">Click here for Free download</a>
                        <span class="blink h1 wine-color"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="100" height="100">
                                <g fill='#800000'>
                                    <path
