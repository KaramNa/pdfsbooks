    ...
    <div class="container">
        <div class="box information">
            ...
            <ul class="social">
                <li>
                    <a href="https://www.facebook.com/groups/594645551607306" class="facebook" target="_blank"
                        ...
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-f"
                            ...
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width="25">
                ...
                <li>
                    <a href="https://twitter.com/pdfsbooks_" class="twitter" target="_blank" title="Twitter link">
                ...
                <li>
                    <a href="https://www.instagram.com/pdfsbooks_" class="instagram" target="_blank"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img"
                            preserveAspectRatio="xMidYMid meet" viewBox="0 0 1536 1536" width="30">
                            <path fill="currentColor"
                ...
                <li>
                    <a href="https://www.pinterest.com/freepdfsbooks1" class="pinterest" target="_blank"
                        ...
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="pinterest-p"
                            ...
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="25">
                            <path fill="currentColor"
...
{{-- <script>
    window.onload = function() {
        ...
        if (ad && ad.innerHTML.replace(/\s/g, "").length == 0) {
            ...
            document.getElementById("free_download_link_button").style.cssText = 'display:block !important';
...
<script type="text/javascript">
    var sc_project = 12770038;
    var sc_invisible = 1;
    var sc_security = "36fccb49";
</script>
<script type="text/javascript" src="https://www.statcounter.com/counter/counter.js" async></script>
<noscript>
    <div class="statcounter"><a title="Web Analytics Made Easy -
Statcounter" href="https://statcounter.com/"
            target="_blank"><img class="statcounter" src="https://c.statcounter.com/12770038/0/36fccb49/1/"
