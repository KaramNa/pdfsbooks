    ...
    <div class="container my-100 how-to-download">
        <div class="mb-100">
            ...
            <div>
                ...
                <div class="text-center"><img src="{{ asset('storage/1.jpg') }}" alt="find download link"></div>
            </div>
            <x-adsense />
            <div>
                ...
                <div class="text-center"><img src="{{ asset('storage/2.jpg') }}" alt="find download link"></div>
            </div>
        </div>
        <x-adsense />
