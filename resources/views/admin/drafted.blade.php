    ...
    <div class="container">
        <form action="{{ route('publish.drafted.books') }}" method="POST">
            ...
            @php
                ...
                // $btnDelete = '<x-adminlte-button label="Open Modal" data-toggle="modal" data-target="#deleteModal" class="btn btn-xs btn-default text-danger mx-1 shadow" title="Delete" > <i class="fa fa-lg fa-fw fa-trash"></i></x-adminlte-button>';
