        ...
        <form action="{{ route('publish.drafted.books') }}" method="POST">
            ...
            @php
                ...
                foreach ($books as $book) {
                    ...
                    $recored = ['<input type="checkbox" name="drafted[]" value="' . $book->id . '">', $book->id, $book->title, $book->draft == 1 ? 'Drafted' : 'Published', '<nobr>' . $btnDraft . $btnPublish . $btnEdit . $btnDelete . $btnDetails . '</nobr>'];
