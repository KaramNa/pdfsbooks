    ...
    <div itemscope itemtype="https://schema.org/Book" itemid="https://pdfsbooks.com/book/{{ $book->slug }}"
        ...
        <div class="wrap content">
            <div class="left-section">
                ...
                <div class="text-center my-20">
                    <iframe sandbox="allow-popups allow-scripts allow-modals allow-forms allow-same-origin"
                        style="width:200px;height:240px;" marginwidth="0" marginheight="0" scrolling="no" frameborder="0"
            ...
            <div class="right-section">
                <div>
                    <a href="#details" id="a_details" onclick="return tab('details')" class="btn-menu active"
                        title="Book Details">
                        <span>Details</span>
                    </a>
                    <a href="#description" id="a_description" onclick="return tab('description')" class="btn-menu"
                ...
                <div class="details form">
                    <a id="details"></a>
                    <div id="t_details" class="tab active">
                        <div>
                    ...
                    <a id="description"></a>
                    <div id="t_description" class="tab">
