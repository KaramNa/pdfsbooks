        ...
        <div id="books" class="container books-filter">
            ...
            <div>
                ...
                <div class="tags">
                    @foreach ($tags as $tag)
                        @if ($tag->tag)
                            <a href="/?tag={{ $tag->tag }}&{{ http_build_query(request()->except(['tag', 'category','search'])) }}" class="tag" title="{{ $tag->tag }} eBooks">
